...
export const projects: Project[] = [
  {
    ...
    techStack: [
      ...
      {
        category: "Deployment",
        tools: ["AWS EC2", "AWS Lambda", "Docker", "Kubernetes"],
      },
...

  {
    ...
    techStack: [
      ...
      { category: "Analytics", tools: ["PostHog"] },
      { category: "Deployment & CI/CD", tools: ["Vercel", "GitHub Actions"] },
    ],
...

  {
    ...
    techStack: [
      ...
      { category: "Analytics", tools: ["PostHog"] },
      { category: "Deployment", tools: ["Docker", "Kubernetes", "AWS"] },
      { category: "CI/CD", tools: ["GitHub Actions"] },
    ],
    category: "Marketplace",
...

  {
    ...
    coverFit: "mark",
    tech: ["Next.js", "TypeScript", "TailwindCSS", "Vercel", "GitHub Actions"],
    techStack: [
      { category: "Frontend", tools: ["Next.js", "TypeScript"] },
      { category: "Styling", tools: ["TailwindCSS"] },
      { category: "Deployment & CI/CD", tools: ["Vercel", "GitHub Actions"] },
...

  {
    ...
    techStack: [
      ...
      { category: "Deployment", tools: ["Docker", "Kubernetes", "Google Cloud"] },
      { category: "CI/CD", tools: ["GitHub Actions"] },
    ],
    category: "AI",
    capabilities: ["AI"],
...

  {
    ...
    techStack: [
      { category: "Frontend", tools: ["React"] },
      { category: "Backend", tools: ["Node.js", "Express", "Go"] },
...

  {
    ...
    techStack: [
      { category: "Backend", tools: ["Python", "FastAPI"] },
      { category: "Cloud", tools: ["AWS", "Docker", "Kubernetes"] },
      { category: "CI/CD", tools: ["GitHub Actions"] },
...

  {
    ...
    coverFit: "cover",
    coverFrame: "native",
    tech: ["Next.js", "OpenAI Realtime API", "Vercel", "GitHub Actions"],
    techStack: [
